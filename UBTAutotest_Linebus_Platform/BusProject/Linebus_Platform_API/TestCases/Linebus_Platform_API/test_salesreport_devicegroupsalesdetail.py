...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("salesreport_dgs_detail")


@ddt
class Salesreport_devicegroupsalesdetail(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_salesreport_devicegroupsalesdetail(self, datas):
