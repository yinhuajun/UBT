...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("thirdparty_r_c_refund")


@ddt
class Thirdparty_r_c_refund(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_thirdparty_r_c_refund(self, datas):
