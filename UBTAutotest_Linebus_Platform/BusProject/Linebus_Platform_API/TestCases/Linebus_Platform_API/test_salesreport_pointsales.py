...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("salesreport_pointsales")


@ddt
class Salesreport_pointsales(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_salesreport_pointsales(self, datas):
