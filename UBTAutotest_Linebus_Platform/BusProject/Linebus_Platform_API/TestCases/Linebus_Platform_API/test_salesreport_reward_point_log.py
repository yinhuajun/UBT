...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("salesreport_r_p_log")


@ddt
class Salesreport_r_p_log(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_salesreport_r_p_log(self, datas):
