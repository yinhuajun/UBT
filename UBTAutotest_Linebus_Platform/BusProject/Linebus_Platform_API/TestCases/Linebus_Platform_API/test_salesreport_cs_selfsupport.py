...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("salesreport_cs_selfsupport")


@ddt
class Salesreport_Cs_Selfsupport(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_salesreport_cs_selfsupport(self, datas):
