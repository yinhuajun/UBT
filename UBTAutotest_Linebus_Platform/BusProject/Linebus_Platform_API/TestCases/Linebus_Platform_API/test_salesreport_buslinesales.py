...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("salesreport_buslinesales")


@ddt
class Salesreport_Buslinesales(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_salesreport_buslinesales(self, datas):
