...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("salesreport_channelsales")


@ddt
class Salesreport_Channelsales(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_salesreport_channelsales(self, datas):
