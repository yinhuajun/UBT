...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("salesreport_refundandreschedule")


@ddt
class Salesreport_refundandreschedule(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_salesreport_refundandreschedule(self, datas):
