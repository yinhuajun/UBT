...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("salesreport_devicegroupsales")


@ddt
class Salesreport_devicegroupsales(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_salesreport_devicegroupsales(self, datas):
