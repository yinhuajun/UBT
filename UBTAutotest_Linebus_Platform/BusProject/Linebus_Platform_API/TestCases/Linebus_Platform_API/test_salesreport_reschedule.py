...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("salesreport_reschedule")


@ddt
class Salesreport_reschedule(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_salesreport_reschedule(self, datas):
