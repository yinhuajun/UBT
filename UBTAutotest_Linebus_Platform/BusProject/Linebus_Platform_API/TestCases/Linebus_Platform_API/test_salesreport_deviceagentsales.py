...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("salesreport_deviceagentsales")


@ddt
class Salesreport_deviceagentsales(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_salesreport_deviceagentsales(self, datas):
