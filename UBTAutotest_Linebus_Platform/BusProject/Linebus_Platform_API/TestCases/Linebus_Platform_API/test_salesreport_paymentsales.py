...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("salesreport_paymentsales")


@ddt
class Salesreport_paymentsales(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_salesreport_paymentsales(self, datas):
