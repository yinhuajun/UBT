...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("salesreport_luggage")


@ddt
class Salesreport_luggage(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_salesreport_luggage(self, datas):
