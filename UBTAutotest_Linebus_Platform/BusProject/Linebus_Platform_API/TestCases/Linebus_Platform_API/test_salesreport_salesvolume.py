...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("salesreport_salesvolume")


@ddt
class Salesreport_salesvolume(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_salesreport_salesvolume(self, datas):
