...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("userreport_r_u_c_count")


@ddt
class Userreport_r_u_c_count(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_userreport_r_u_c_count(self, datas):
