...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("salesreport_cs_detail")


@ddt
class Salesreport_Channelsales_Datail(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_salesreport_cs_detail(self, datas):
