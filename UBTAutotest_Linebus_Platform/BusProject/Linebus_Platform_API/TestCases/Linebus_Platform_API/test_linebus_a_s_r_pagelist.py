...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("linebus_a_s_r_pagelist")


@ddt
class Linebus_a_s_r_pagelist(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_linebus_a_s_r_pagelist(self, datas):
