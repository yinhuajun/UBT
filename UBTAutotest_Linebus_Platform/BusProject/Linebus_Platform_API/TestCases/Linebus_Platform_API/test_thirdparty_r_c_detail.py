...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("thirdparty_r_c_detail")


@ddt
class Thirdparty_r_c_detail(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_thirdparty_r_c_detail(self, datas):
