...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("salesreport_cs_thirdparty")


@ddt
class Salesreport_cs_thirdparty(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_salesreport_cs_thirdparty(self, datas):
