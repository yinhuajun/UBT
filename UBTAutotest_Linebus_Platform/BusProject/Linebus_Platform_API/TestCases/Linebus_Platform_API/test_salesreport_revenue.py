...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("salesreport_revenue")


@ddt
class Salesreport_revenue(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_salesreport_revenue(self, datas):
