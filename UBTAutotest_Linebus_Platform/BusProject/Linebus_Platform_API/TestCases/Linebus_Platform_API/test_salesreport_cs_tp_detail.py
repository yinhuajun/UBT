...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("salesreport_cs_tp_detail")


@ddt
class Salesreport_cs_tp_detail(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_salesreport_cs_tp_detail(self, datas):
