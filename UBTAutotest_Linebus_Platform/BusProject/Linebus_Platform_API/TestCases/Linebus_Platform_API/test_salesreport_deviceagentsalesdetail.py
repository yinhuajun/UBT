...
testdata = ReadDatas(DataPaths.DatasPath).read_datas("salesreport_ds_detail")


@ddt
class Salesreport_ds_detail(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.log = MyLogs()
    ...
    @data(*testdata)
    def test_salesreport_ds_detail(self, datas):
